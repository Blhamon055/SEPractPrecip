...
var chemAws = ["Hg\u2082(NO\u2083)\u2082", "CaCl\u2082","MgSO\u2084","NaOH","CaO", "Na\u2083PO\u2084", "K\u2082CO\u2083","none", "NaOH", "CaCl\u2082", "FeCl\u2083", "Na\u2082S", "NaOH", "none", "NaCl", "BaCl\u2082", "Ca(NO\u2083)\u2082", "CuCl\u2082", "K\u2082S", "Na\u2082CO\u2083"]
...
func _selectProb():
	...
	print(answer)
	print(idxAns)
	get_node("/root/Main/HUD")._updateTB(compoundChoices[0],compoundChoices[1],compoundChoices[2],"none")
